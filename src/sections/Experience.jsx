  ...
  const experiences = [
    {
      ...
      logo: '/exp-logos/ayc.jpg', // Add your logo file
    ...
    },
    {
      ...
      logo: '/exp-logos/vibgyor.jpeg', // Add your logo file
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        >
          ...
          <div className="relative">
            {/* Timeline line */}
            <div className="absolute left-6 md:left-1/2 top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-500 to-purple-500 transform -translate-x-1/2 hidden md:block"></div>
              ...
              {experiences.map((exp, index) => (
                ...
                >
                  ...
                  <div className="hidden md:flex relative flex-shrink-0">
                    <div className="w-4 h-4 bg-gradient-to-r from-blue-600 to-purple-600 rounded-full border-4 border-white dark:border-gray-900 shadow-lg z-10"></div>
                  </div>

                  {/* Content Card */}
                  <motion.div
                    whileHover={{ y: -5 }}
                    className="flex-1 bg-white dark:bg-gray-800 rounded-3xl p-8 shadow-2xl border border-gray-200 dark:border-gray-700 hover:shadow-3xl transition-all duration-500"
                  >
                    <div className="flex flex-col lg:flex-row gap-6">
                      {/* Company Logo */}
                      <div className="flex-shrink-0">
                        <div className="w-20 h-20 rounded-2xl bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-700 dark:to-gray-800 p-4 shadow-lg border border-gray-300 dark:border-gray-600 flex items-center justify-center">
                          <img 
                            src={exp.logo} 
                          ...
                          />
                          {/* Fallback icon */}
                          <div className="hidden w-12 h-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded-lg items-center justify-center text-white">
